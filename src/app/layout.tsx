  ...
  return (
    <html lang='en'>
      ...
      <body className={`${lato.variable} `}>
        <Header />
        <main className='-z-10 container mx-auto flex h-[calc(100dvh-72px)] flex-col justify-between px-15 lg:px-20'>
          <div className='mt-15 mb-10 flex h-auto w-full flex-col gap-10'>
